...
public final class Params {
    ...
    static {
        ...
        k("in", "анимация появления", "fly", "none", "fade", "type", "wipe", "rise", "drop", "explode", "scale", "spiral");
        k("out", "анимация исчезновения", "fly", "none", "fade", "scatter", "fall", "dissolve", "wipe", "implode", "shrink");
        ...
        k("face", "куда повёрнута фигура", "player", "north", "south", "east", "west", "up", "down", "auto");
